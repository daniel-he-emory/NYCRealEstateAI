-- NYC Real Estate AI - Complete Migration with Building Age Trigger
...
-- Add building_age column with trigger
...
-- Done!
SELECT 'NYC Real Estate AI database schema created successfully!' as status;
